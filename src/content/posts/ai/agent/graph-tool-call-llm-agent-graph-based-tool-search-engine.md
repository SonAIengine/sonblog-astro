...
이 글은 초기 검색 아키텍처를 다룬다. 이후 “최종 도구를 찾는 것”과 “실행에 필요한 선행 도구를 모두 붙이는 것”을 분리해 검증한 과정은 [graph-tool-call v0.36 의존성 완성 글](/ai/agent/graph-tool-call-v036-evidence-gated-dependency-closure/)에서 이어진다.
